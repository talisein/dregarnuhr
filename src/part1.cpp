...
{ volume::MP1V1, "page-151"sv, "xhtml/p-151.xhtml"sv, "application/xhtml+xml"sv, "Extra: Myne's Gotten Weird"sv, true },
...
{ volume::MP1V3, "page-184"sv, "xhtml/p-184.xhtml"sv, "application/xhtml+xml"sv, std::make_optional<std::string_view>("Story: The Baptism Ceremony and the Hairpin"sv), true },
...
{ volume::MP1V4, "page-166"sv, "xhtml/p-166.xhtml"sv, "application/xhtml+xml"sv, std::make_optional<std::string_view>("Story: Zeg the Apprentice Craftsman"sv), true },
...
{ volume::MP1V5, "page-176"sv, "xhtml/p-176.xhtml"sv, "application/xhtml+xml"sv, std::make_optional<std::string_view>("Story: Hairpins and the Meeting of Stores"sv), true },
...
{ volume::MP1V6, "page-182"sv, "xhtml/p-182.xhtml"sv, "application/xhtml+xml"sv, std::make_optional<std::string_view>("Story: A Long-Awaited Reunion"sv), true },
...
{ volume::MP1V7, "page-210"sv, "xhtml/p-210.xhtml"sv, "application/xhtml+xml"sv, std::make_optional<std::string_view>("Story: As the Gilberta Company's Successor"sv), true },
